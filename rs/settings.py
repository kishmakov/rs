...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_LOCATION, 'tests.db').replace('\\', '/'),
...
STATIC_ROOT = os.path.join(PROJECT_LOCATION, 'static').replace('\\','/')
...
SECRET_KEY = '6ccm&amp;mmy+38b&amp;71($(nu5w9e28p07%uz&amp;v80r7y=1)@h$78mse'
...
TEMPLATE_DIRS = (
    os.path.join(PROJECT_LOCATION, 'templates').replace('\\','/'),
)
